...
import com.hooha.maidai.chat.utils.CrashHandler;
...
public class InitBusinessHelper {
    ...
    public static void initTls(Context context) {
        mLoginHelper = TLSLoginHelper.getInstance().init(context, Constant.SDK_APPID, Constant.ACCOUNT_TYPE, appVer);
        mLoginHelper.setTimeOut(5000);
        mAccountHelper = TLSAccountHelper.getInstance().init(context, Constant.SDK_APPID, Constant.ACCOUNT_TYPE, appVer);
