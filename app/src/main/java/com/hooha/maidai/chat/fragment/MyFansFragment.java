...
public class MyFansFragment extends Fragment {
    ...
    private View view;
    private List<Fans> myFansList;

    public static MyFansFragment newInstance(String keyWord) {
...
//            initList();
    ...
    private void initView() {
        ...
        MyFollowAdapter adapter = new MyFollowAdapter(myFansList, getActivity(), "MyFansFragment");
