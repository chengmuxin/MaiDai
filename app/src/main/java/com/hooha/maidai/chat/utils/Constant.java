...
//    public static final int SDK_APPID = 1400001533;
    ...
    public static final int SDK_APPID = 1400011534;//FEI

    //    public static final int ACCOUNT_TYPE = 884;
    public static final int ACCOUNT_TYPE = 6053;//FEI
    ...
    public static final int AVIMCMD_Host_Flower = AVIMCMD_Host_Back + 1;        // 送主播花消息  6
    public static final int AVIMCMD_Interaction_Flower = AVIMCMD_Host_Flower + 1; // 送互动观众花消息  7
    public static final int AVIMCMD_Host_Present = AVIMCMD_Interaction_Flower + 1;       // 送主播礼物消息  8
    public static final int AVIMCMD_Interaction_Present = AVIMCMD_Host_Present + 1;// 送互动观众礼物消息  9
    public static final int AVIMCMD_Interaction_Praise = AVIMCMD_Interaction_Present + 1; // 送互动观众赞消息  10
    public static final int AVIMCMD_Ready_Game = AVIMCMD_Interaction_Praise + 1;  //准备游戏  11
    public static final int AVIMCMD_Start_Game = AVIMCMD_Ready_Game + 1;  //开始游戏  12
    ...
    public static final int GAME_TIME = 60 * 1000; //游戏比赛总时长
}
