...
public class CheckableView extends FrameLayout implements View.OnClickListener {
    ...
    public void setLabel(String label) {
        ...
        if (getLabel() != null) {
            ...
            ((LayoutParams) mImageViewContainer.getLayoutParams()).bottomMargin = getResources().getDimensionPixelSize(R.dimen.checkable_image_container_margin) * 2;
        } else {
            getLabelView().setVisibility(View.GONE);
            ((LayoutParams) mImageViewContainer.getLayoutParams()).bottomMargin = getResources().getDimensionPixelSize(R.dimen.checkable_image_container_margin);
        }
    ...
    private void initCheckableOverlayPosition() {
        switch (getCheckmarkPosition()) {
            ...
            case CENTER:
                ...
                if (getLabel() != null) {
                    ((LayoutParams) mCheckedOverlay.getLayoutParams()).bottomMargin = (getResources().getDimensionPixelSize(R.dimen.checkable_overlay_margin) / 2) +
            ...
            case BOTTOM_LEFT:
                ...
                if (getLabel() != null) {
                    ((LayoutParams) mCheckedOverlay.getLayoutParams()).bottomMargin = getResources().getDimensionPixelSize(R.dimen.checkable_overlay_margin) +
