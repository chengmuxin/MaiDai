...
//        accountHelper.setTestHost("113.108.64.238", false);    // 不走sso
    ...
    public int smsSetPassword(String password, TLSPwdRegListener listener) {
    ...
    public void initSmsRegisterService(Context context,
        ...
        smsRegisterService = new SmsRegisterService(context, txtCountryCode, txtPhoneNumber, txtCheckCode, pw_hostRegister,
