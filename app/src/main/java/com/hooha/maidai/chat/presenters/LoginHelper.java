...
import com.hooha.maidai.chat.presenters.viewinface.LoginView;
import com.hooha.maidai.chat.presenters.viewinface.LogoutView;
...
//                SxbLog.i(TAG, "TLS OnPwdLoginSuccess " + tlsUserInfo.identifier);
    ...
    private void startAVSDK() {
        QavsdkControl.getInstance().setAvConfig(Constant.SDK_APPID, "" + Constant.ACCOUNT_TYPE, MySelfInfo.getInstance().getId(), MySelfInfo.getInstance().getUserSig());
        Log.i(TAG, "startAVSDK: " + Constant.SDK_APPID);
        Log.i(TAG, "startAVSDK: " + Constant.ACCOUNT_TYPE);
        Log.i(TAG, "startAVSDK: " + MySelfInfo.getInstance().getId());
        Log.i(TAG, "startAVSDK: " + MySelfInfo.getInstance().getUserSig());
