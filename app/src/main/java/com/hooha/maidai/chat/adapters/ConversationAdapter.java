...
import com.hooha.maidai.chat.utils.TimeUtil;
...
public class ConversationAdapter extends ArrayAdapter<Conversation> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Log.d("cmx", "data: " + data.getIdentify() + "|" + data.getName() + "|" + data.getAvatar());
        viewHolder.tvName.setText(data.getName());
        viewHolder.avatar.setImageResource(R.color.background_gray3);
        viewHolder.avatar.setImageUrl(data.getAvatar());
