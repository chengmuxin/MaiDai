...
import com.hooha.maidai.chat.activity.SettingActivity;
 ...
 * 在线消息通知展示
 */
public class PushUtil extends Activity implements Observer {
    ...
    private void PushNotify(TIMMessage msg){
        ...
        if ( UserInfo.getInstance().getSwitch_btn()){
...
//                .setNumber(++pushNum) //设置通知集合的数量
                ...
                .setDefaults(Notification.FLAG_NO_CLEAR)//向通知添加声音、闪灯和振动效果的最简单、最一致的方式是使用当前的用户默认设置，使用defaults属性，可以组合
