...
import com.hooha.maidai.chat.service.Constants;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(IndependentLoginActivity.this, ResetPhonePwdActivity.class);
        ...
        findViewById(MResource.getIdByName(getApplication(), "id", "registerNewUser"))
                .setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(IndependentLoginActivity.this, HostRegisterActivity.class);
